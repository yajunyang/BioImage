 ...
 * objects in algorithms that do frequent allocations/deallocations of this type
 * (which is straining for the Java virtual machine).
 */
public class BandElementCache {
	...
	final public BandElement getRecycledBandElement(final int x, final int y,
			final int z, final double value) {
