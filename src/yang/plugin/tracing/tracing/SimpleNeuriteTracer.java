	...
	*/
	...
	synchronized void testPathTo( double world_x, double world_y, double world_z, PointInImage joinPoint ) {
		...
		if (tubularGeodesicsTracingEnabled) {
			...
			// [xyz]_spacing
							System.out.println("tubularGeodesicsThread starts...");
...
//							System.out.println();
//							System.out.println("========================================");
//							System.out.println("=======SimpleNeuriteTracer.java======816");
//							System.out.println("========================================");
//							System.out.println("tracerThread starts...");
//							System.out.println("stackMin =  " + stackMin + "  stackMax =  " + stackMax);
//							System.out.println("startX =  " + last_start_point_x + " startY = " + last_start_point_y + " startZ =  " + last_start_point_z);
//							System.out.println("goalX = " + x_end + " goalY= " + y_end + " goalZ =  " + z_end);
//							System.out.println("singleSlice = " + singleSlice);
//							System.out.println("About hessian: " + hessian + ", " + "which is a object of ComputeCurvatures");
//							System.out.println("multiplier = " + resultsDialog.getMultiplier());
//							System.out.println("tubeness = " + tubeness);
//							System.out.println("Is hassian enabled? " + hessianEnabled);
			...
			currentSearchThread.setDrawingColors( Color.YELLOW, null );
